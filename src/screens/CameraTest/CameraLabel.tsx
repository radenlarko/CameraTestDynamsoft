...
const CameraLabel = () => {
  ...
  const [imageData, setImageData] = useState(undefined as undefined | string);
  ...
  const frameProcessor = useFrameProcessor(frame => {
    ...
    if (modalVisibleShared.value === false) {
      ...
      config.license =
        'DLS2eyJoYW5kc2hha2VDb2RlIjoiMTAwMjI3NzYzLVRYbE5iMkpwYkdWUWNtOXFYMlJzY2ciLCJvcmdhbml6YXRpb25JRCI6IjEwMDIyNzc2MyIsImNoZWNrQ29kZSI6LTE4MDg2NTM3MjV9';
      ...
      if (modalVisibleShared.value === false) {
        ...
        if (lineResults.length === 2 || (!useCase && lineResults.length > 0)) {
